-- Schema PostgreSQL completo para TKookies ERP
-- Executar no Neon (ou qualquer PostgreSQL) para criar todas as tabelas do zero
...
-- Composição produto-ingrediente
...
-- Produtos Agregados (Extras / Venda casada)
