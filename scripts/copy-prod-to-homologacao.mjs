 ...
 * Uso: node scripts/copy-prod-to-homologacao.mjs
 */

// Rodado de dentro de /backend (tem mysql2 instalado):
//   cd backend && node ../scripts/copy-prod-to-homologacao.mjs
...
async function initSchema(homo) {
  ...
  const schema = [
    ...
    `CREATE TABLE IF NOT EXISTS produto_imagens (
      ...
      imagem TEXT, eh_capa BOOLEAN DEFAULT FALSE,
      FOREIGN KEY (produto_id) REFERENCES produtos(id) ON DELETE CASCADE)`,
    ...
    `CREATE TABLE IF NOT EXISTS combos (
      ...
      produto_id INT, imagem TEXT, ativo BOOLEAN DEFAULT TRUE,
      created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP)`,
    ...
    `CREATE TABLE IF NOT EXISTS configuracoes (
      ...
      chave VARCHAR(50) NOT NULL UNIQUE, valor TEXT)`,
    ...
    `CREATE TABLE IF NOT EXISTS depoimentos (
      ...
      imagem TEXT, ativo BOOLEAN DEFAULT TRUE,
      created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP)`,
